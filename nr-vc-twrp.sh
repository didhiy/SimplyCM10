...
DEFCONFIG_STRING=cyanogenmod_epicmtd_nr_defconfig
PRJROOT=$PWD
CUSTOMVERSION=nitest-jb42_nr-vc-twrp-`date +%m%d`
...
echo "Building kernel"
		...
		git am patch/0001-Revert-Revert-Voodoo-Color-by-Supercurio-https-githu.patch
		START_TIME=`date +%s`
